    ...
    <div>
      <div className="flex flex-row justify-between align-middle md:pt-2">
        <div className="scroll-m-20">
          <h1 className="text-xl font-extrabold tracking-tight md:text-4xl lg:text-3xl text-black">
            Thilakraj Shetty H
          </h1>
          <h1 className="text-m font-medium tracking-tight text-blue-500">
      ...
      <blockquote className="mt-2 border-l-2 border-l-yellow-100 pl-6 font-medium text-sm md:text-lg text-justify">
